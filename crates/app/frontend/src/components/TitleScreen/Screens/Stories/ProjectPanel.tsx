...
export const ProjectPanel = (props: {
    ...
    return <div class="hover:scale-[1.008] transition">
        <div class="w-[50vw] h-[89px] border border-neutral-700 drop-shadow-lg rounded flex flex-col gap-3 cursor-pointer px-[18px] py-[12px] animate-[scale-in-center_0.2s_cubic-bezier(0.250,_0.460,_0.450,_0.940)_both]" onClick={() => openProject(props.project)}>
